...
class BackupTests(unittest.TestCase):
    def setUp(self):
        ...
        self.fastq_filepath = os.path.join(
            self.curr_dir,
        ...
        self.sample_sheet_fp = os.path.join(
            self.curr_dir, "170323_M04734_0028_000000000-B2MVT/test_sample_sheet.txt"
        )
    ...
    def test_return_md5(self):
        self.assertEqual(
            return_md5(self.fastq_filepath), "13695e47114c02536ae3ca6823a42261"
        )
